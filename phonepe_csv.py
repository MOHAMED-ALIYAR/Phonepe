...
state = pd.read_csv(r"C:\Users\admin\Capstone\Phonepe\CSV\Longitude_Latitude_State_Table.csv")
districts = pd.read_csv(r"C:\Users\admin\Capstone\Phonepe\CSV\Data_Map_Districts_Longitude_Latitude.csv")
districts_tran = pd.read_csv(r"C:\Users\admin\Capstone\Phonepe\CSV\district_map_transaction.csv")
app_opening = pd.read_csv(r"C:\Users\admin\Capstone\Phonepe\CSV\district_registering_map.csv")
user_device = pd.read_csv(r"C:\Users\admin\Capstone\Phonepe\CSV\user_by_device.csv")
